...
<?php
	$info_message  = apply_filters( 'woocommerce_checkout_login_message', __( 'Returning customer?','bronx' ) );
	$info_message .= ' <a href="#" class="showlogin">' . __( 'Click here to login','bronx' ) . '</a>';
