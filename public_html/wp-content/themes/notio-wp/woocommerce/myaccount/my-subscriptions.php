...
<?php if ( ! empty( $subscriptions ) ) : ?>
	<div class="largetitle"><?php echo apply_filters( 'woocommerce_my_account_my_subscriptions_title', __( 'My Subscriptions','bronx' ) ); ?></div>
	...
	<table class="shopping_bag">
		...
		<thead>
			<tr>
				...
				<th class="subscription-title"><span class="nobr"><?php _e( 'Subscription', 'bronx' ); ?></span></th>
				<th class="order-status"><span class="nobr"><?php _e( 'Status', 'bronx' ); ?></span></th>
				<th class="subscription-next-payment"><span class="nobr"><?php _e( 'Next Payment', 'bronx' ); ?></span></th>
				<th class="subscription-end"><span class="nobr"><?php _e( 'End Date', 'bronx' ); ?></span></th>
				<th class="order-actions"><span class="nobr"><?php _e( 'Actions', 'bronx' ); ?></th>
			</tr>
		</thead>
