...
<aside class="share_wrapper">
	<a href="#product_share" class="btn large" id="share-post-link" data-fb="<?php echo (in_array('facebook',$sharing_type) ? 'true' : 'false' ); ?>" data-tw="<?php echo (in_array('twitter',$sharing_type) ? 'true' : 'false' ); ?>" data-pi="<?php echo (in_array('pinterest',$sharing_type) ? 'true' : 'false' ); ?>"><?php _e('Share', 'bronx'); ?></a>
	<div class="share_container">
		<div class="spacer"></div>
		<div class="vcenter">
			<aside id="product_share">
				<h6><?php _e('SHARE', 'bronx'); ?></h6>
