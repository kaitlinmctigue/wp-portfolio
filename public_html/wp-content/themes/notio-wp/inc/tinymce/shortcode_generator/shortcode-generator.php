...
<div id="shortcode-generator">
	...
	<div class="shortcode-content">
		...
		<div class="content"><select id="thb-shortcodes" data-placeholder="' . __("Choose a shortcode", 'bronx') .'">
	    <option></option>';
...
<?php echo $shortcode_html . $html_options;  ?>
	...
	<a class="thb-btn" id="add-shortcode"><?php echo __( 'Add Shortcode', 'bronx' ); ?></a>
