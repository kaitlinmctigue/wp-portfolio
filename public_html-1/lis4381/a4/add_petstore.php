					...
					<h2>Pet Stores</h2>
						...
						<form id="defaultForm" method="post" class="form-horizontal" action="add_petstore_process.php">
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
												<input type="text" class="form-control" maxlength="10" name="phone" placeholder="(10 digits no dashes)"/>
										</div>
								</div>
								...
								<div class="form-group">
										...
										<div class="col-sm-5">
												<input type="text" class="form-control" maxlength="100" name="url" placeholder="Example: www.somerandomdomain.com" />
										</div>
								</div>
