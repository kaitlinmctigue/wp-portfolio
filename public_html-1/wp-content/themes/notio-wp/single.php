  ...
  <article itemscope itemtype="http://schema.org/BlogPosting" <?php post_class('post style1 blog-post'); ?> id="post-<?php the_ID(); ?>" role="article">
  	<?php if ( has_post_thumbnail() ) { ?>
  		<?php
  		    ...
  		    $image_link = wp_get_attachment_image_src($image_id,'notio-single');
  		?>
...
<!-- End #comments -->
<?php do_action( 'thb_post_navigation', array('post', get_permalink( get_option( 'page_for_posts' ) ), __('BACK TO BLOG', 'bronx') ) ); ?>
<?php get_footer(); ?>
