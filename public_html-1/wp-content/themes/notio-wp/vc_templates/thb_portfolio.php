 	...
 	<?php if ($a['style'] == 'masonry') { ?>
 		<section class="thb-portfolio masonry row" data-loadmore="#loadmore-<?php echo $rand; ?>">
 			<?php if ($a['add_filters'] == 'true') { ?>
	 			<ul class="filters">
	 				<li><h6><a href="#" data-filter="*" class="all active"><?php _e( 'show all', 'bronx' ); ?></a></h6></li>
	 				<?php 
	 			...
	 			<a href="#" class="thb-toggle"><h6><?php _e( 'Filters', 'bronx' ); ?></h6></a>
	 		<?php } ?>
 			<?php $i = 1; ?>
 		...
 		<?php if ($a['loadmore']) { ?>
 		<a class="masonry_btn" href="#" id="loadmore-<?php echo $rand; ?>" data-type="portfolio" data-loading="<?php _e( 'Loading Posts', 'bronx' ); ?>" data-nomore="<?php _e( 'No More Posts to Show', 'bronx' ); ?>" data-initial="<?php echo $a['item_count']; ?>" data-count="<?php echo $a['retrieve']; ?>" data-categories="<?php echo $a['categories']; ?>" data-masonry="<?php echo $a['masonry_style']; ?>"><?php _e( 'Load More', 'bronx' ); ?></a>
 		<?php } ?>
