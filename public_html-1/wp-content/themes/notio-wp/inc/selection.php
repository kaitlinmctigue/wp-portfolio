...
.overlay-effect .simple-overlay {
	background: rgba(<?php echo thb_hex2rgb($accent_color); ?>, 0.95);
}
.portfolio_nav a .overlay {
	background: rgba(<?php echo thb_hex2rgb($accent_color); ?>, 0.8);
}
...
#full-menu .sf-menu > li > a {
	<?php thb_typeecho(ot_get_option('menu_type'), false, 'Montserrat'); ?>
}

.mobile-menu ul.sub-menu li a,
#full-menu ul.sub-menu li a {
	<?php thb_typeecho(ot_get_option('menu_submenu_type'), false, 'Source Code Pro'); ?>
}
