...
<div class="largetitle"><?php echo apply_filters( 'woocommerce_my_account_my_orders_title', __( 'My Wishlist','bronx' ) ); ?></div>
    ...
    <table class="shopping_bag wishlist">
    	<thead>
    		<tr>
    			...
    			<th class="product-price"><?php _e( 'Price', 'bronx') ?></th>
    			<th class="product-quantity"><?php _e( 'Stock Status', 'bronx' ) ?></th>
        ...
        <tbody>
            ...
            if( count( $wishlist ) > 0 ) :
                    ...
                    <tr id="yith-wcwl-row-<?php echo $values['ID'] ?>">
                        ...
                        <td class="product-quantity">
                            ...
                            if( $stock_status == 'out-of-stock' ) {
                                $stock_status = "Out";
                                echo '<span class="wishlist-out-of-stock">' . __( 'Out of Stock', 'bronx' ) . '';   
                            } else {
                                $stock_status = "In";
                                echo '<span class="wishlist-in-stock">' . __( 'In Stock', 'bronx' ) . '';
                            }
                            ?>
                        </td>
                        ...
                        <td class="product-remove"><div><a href="javascript:void(0)" onclick="remove_item_from_wishlist( '<?php echo esc_url( $yith_wcwl->get_remove_url( $values['ID'] ) )?>', 'yith-wcwl-row-<?php echo $values['ID'] ?>');" class="remove" title="<?php _e( 'Remove this product', 'bronx' ) ?>"><i class="icon-budicon-543"></i></a></td>
                    </tr>
                    <?php
                    endif;
                endforeach;
                ...
                <tr>
                    <td colspan="6" class="wishlist-empty"><?php _e( 'Your wishlist is currently empty.', 'bronx' ) ?></td>
                </tr>       
            <?php
            endif;
